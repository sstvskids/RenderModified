...
if v ~= lplr and v.Character and v.Team ~= lplr.Team and isAlive(v) and lplr.Character and lplr.Character.PrimaryPart and (raycastTab and workspace:Raycast(v.Character.PrimaryPart.Position, Vector3.new(0, -2000, 0), raycastTab) or not raycastTab) then
